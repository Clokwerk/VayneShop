                ...
                <div class=" main-content-area">
                    <div class="wrap-login-item ">
                        <div class="register-form form-item ">
                            <form class="form-stl" action="{{route('registerCustom')}}" name="frm-login" method="POST" >
                                ...
                                <fieldset class="wrap-input item-width-in-half ">
                                    ...
                                    <input type="password" id="frm-reg-cfpass" name="confirm-password" placeholder="Confirm Password">
                                </fieldset>
                                @if($error!=null)
